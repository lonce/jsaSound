...
define(
	...
	function (config, baseSM) {
		return function (i_loadedCB, i_fname) {
			...
			// Grab a random bird sound from our collection
			var birdsource=["158527", "240249"];
			var bs = birdsource[Math.floor(2*Math.random())] ;
			var numElements={"158527": 10, "240249":16};
			var elmt=Math.floor(1+numElements[bs]*Math.random());
			var fname = "jsaResources/sounds/birds/" + bs + "_" + elmt + ".mp3";
			console.log("bird source file is " + fname);
