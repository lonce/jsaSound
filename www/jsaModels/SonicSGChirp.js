...
define(
	...
	function (config, baseSM, fmodOscFactory, GraphNode, audioUtils) {
        return function (i_loadedCB) {
            ...
            var notes=[];
            //notes[0] = ["C4", "D4", "E4", "G4", "A4", "C5", "D5", "E5", "G5", "A5", "C6", "D6", "E6", "G6", "A6", "C7", "D7", "E7"];  // C major pentatonic
            //notes[0] = ["C5", "D5", "E5", "G5", "A5", "C6", "D6", "E6", "G6", "A6", "C7", "D7", "E7", "G7", "A7", "C8", "D8", "E8"];  // C major pentatonic
            notes[0] = ["C6", "D6", "E6", "G6", "A6", "C7", "D7", "E7", "G7", "A7", "C8", "D8", "E8", "G8", "A8", "C9", "D9", "E9"];  // C major pentatonic
