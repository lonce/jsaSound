...
define(
	...
	function (config, baseSM, utils) {
		return function (i_loadedCB) {
			...
			// This is a "distributed" sound - different people get diffent wavefiles.
			var sfiles=[];
			numsfiles=2;
			...
			var m_fileLoop=true; // boolean flag
...
//					console.log("Gain set at " + gainLevelNode.gain.value);
			...
			myInterface.onRelease = function (i_ptime) {
				...
				/*
				myInterface.schedule(config.audioContext.currentTime+.1, function () {
					myInterface.stop(0);
				});
				*/
			};
