...
define(
	...
	function (config, baseSM, utils) {
		return function (i_loadedCB) {
			...
			var ṣndlist = ["jsaResources/sounds/swing/149087__forward.mp3",		
				"jsaResources/sounds/swing/117259__end1.mp3",
				"jsaResources/sounds/swing/117259__end2.mp3",
				"jsaResources/sounds/swing/149087__back.mp3"]

			var fname =ṣndlist[Math.floor(4*Math.random())];
