...
//		-bigNum
define(
	["jsaSound/jsaCore/config", "jsaSound/jsaCore/baseSM", "jsaSound/jsaOpCodes/jsaNoiseNode", "jsaSound/jsaOpCodes/jsaMicInputNode"],
	function (config, baseSM, noiseNodeFactory, micInputNode) {
		return function () {
			...
			(function () {
				...
				micInputNode(microphone, m_filterNode);

				//======================================
				// make the graph connections
				//m_noiseNode.connect(m_filterNode); // connect mic instead ...
				m_filterNode.connect(convolver);
				
				convolver.connect(gainEnvNode);
